...
const ScrollFeatureCard = () => {
  ...
  return (
    ...
    <div className='mt-5'>
        ...
        <SubTitle className='w-50 mx-auto'>Tech Cloud ERP offers a cutting-edge solution with seamless integration, intuitive design and robust real-time analytics.
